...
function usage() {
  ...
  info("  kfc session find --id <SESSION_ID>");
  ...
  info("  kfc session push --to <TRANSFER_DIR>/codex-sessions");
  info("  kfc session push --id <SESSION_ID> --to <TRANSFER_DIR>/codex-sessions");
  info("  kfc session pull --from <TRANSFER_DIR>/codex-sessions");
  info("  kfc session pull --from <TRANSFER_DIR>/codex-sessions --id <SESSION_ID>");
  info("  kfc session copy --id <SESSION_ID> --to <TRANSFER_DIR>/codex-sessions");
  info("  kfc session copy --to <TRANSFER_DIR>/codex-sessions --date 2026-03-04");
  info("Options:");
