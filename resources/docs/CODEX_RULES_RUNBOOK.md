...
`kfc client --force` creates or validates config, ensures plan UI availability (project-local install or linked fallback), syncs project rules, syncs the project-local runtime skill to `.agents/skills/kamiflow-core/SKILL.md`, and creates `.kfc/CODEX_READY.md`.
